      ...
      <dialog id="terms_conditions_modal" className="modal">
        <div className="modal-box">
          ...
          <p className="mb-4">
            ...
            Quranic verses, translations, and Islamic information, is for
            educational and informational purposes only.
          </p>

          <p className="mb-4">
            Users must not misuse, copy, or redistribute the content for
            harmful, misleading, or commercial purposes without permission.
          </p>

          <p className="mb-4">
            We do not guarantee that all content is error-free or complete.
            Users are encouraged to verify information with qualified Islamic
            scholars.
          </p>

          <p className="mb-4">
            We are not responsible for any loss, misunderstanding, or damage

...
export default function EidNamaz() {
  return (
    <>
      <SEO
        title="Eid Prayers"
        description="Eid al-Fitr is celebrated on the first day of Shawwal after the completion of Ramadan.
      ...
      <div className="max-w-5xl mx-auto p-4 md:p-6">
              ...
              <table className="table table-zebra">
                <tbody>
                  ...
                  <tr>
                    <th>Time</th>
                    <td>
                      After the sun has risen sufficiently above the horizon
                      until before the time of Dhuhr.
                    </td>
                  </tr>
        ...
        <div className="card bg-base-100 border border-base-300 shadow-sm mb-6">
          <div className="card-body">
            ...
            <p className="text-sm opacity-70 mt-3">
              The intention is fundamentally an intention of the heart; a
              specific spoken formula is not required.
            </p>
          </div>
        </div>
        ...
        <div className="card bg-base-100 border border-base-300 shadow-sm mb-6">
          <div className="card-body">
            ...
            <div className="space-y-3 mt-3">
              ...
              <p>
                Muslims should sit quietly and listen attentively to the
                khutbah.
              </p>

              <p>
                The khutbah may contain reminders about faith, worship,
                gratitude, charity, family, brotherhood and other important
                Islamic teachings.
              </p>
            </div>
          </div>
        ...
        <div className="card bg-base-100 border border-error/30 shadow-sm mb-6">
          <div className="card-body">
            ...
            <ul className="list-disc list-inside space-y-2 mt-3">
              ...
              <li>
                Trying to follow a different school while praying behind an
                Imam.
              </li>
        ...
        <div className="mt-6 text-sm opacity-70 text-center">
          <p>
            ...
            jurisprudence. This page provides general educational information.
            For specific rulings, consult a qualified Islamic scholar.
          </p>
        </div>
      </div>
    </>

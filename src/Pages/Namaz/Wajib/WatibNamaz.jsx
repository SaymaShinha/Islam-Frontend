...
export default function WatirbNamaz() {
  return (
    <>
      <SEO
        title="Watib Prayer"
        description="Witr is a highly emphasized prayer performed after Isha and before Fajr. In Hanafi fiqh, Witr is considered wajib."
        path="/watib-namaz"
      />
      ...
      <div className="max-w-5xl mx-auto p-4 md:p-6">
        ...
        <Section title="How to Perform 3-Rak‘ah Witr">
          ...
          <Step number="5" title="Takbir and Qunut">
            In the Hanafi method, raise the hands for an additional takbir
            before the Qunut supplication and then recite Dua al-Qunut.
          </Step>

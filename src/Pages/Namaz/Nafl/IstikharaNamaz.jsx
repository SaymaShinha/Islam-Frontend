  ...
  return (
    <>
      <SEO
        ...
        description="Istikhara means seeking Allah's guidance when a person is considering a permissible matter and is uncertain about the best choice."
      ...
      <div className="max-w-4xl mx-auto p-4 md:p-6">
        ...
        <div className="alert alert-info mb-6">
          Istikhara means seeking Allah's guidance when a person is considering
          a permissible matter and is uncertain about the best choice.
        </div>
